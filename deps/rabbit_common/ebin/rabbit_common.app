{application,rabbit_common,
             [{description,"Modules shared by rabbitmq-server and rabbitmq-erlang-client"},
              ...
              {modules,[app_utils,code_version,credit_flow,delegate,
                        delegate_sup,ec_semver,ec_semver_parser,ets_compat,
                        file_handle_cache,file_handle_cache_stats,gen_server2,
                        mirrored_supervisor,mnesia_sync,mochijson2,mochinum,
                        mochiweb_util,pmon,priority_queue,
